/**
 * Memory entry list (P4-03).
 *
 * Renders the accumulated entry pages: content (with query-match
 * highlighting), date, source marker (scope badge), and the explicit
 * edit / forget actions. The forget confirmation bar mounts inline per row
 ...
 * forget state machine). In replay/unwired mode (`wired: false`) the action
