...
export const graycodeCheckpointListDictionaries: Record<LocaleId, LocaleDictOf<'graycode.checkpointList'>> = {
  zh: {
    ...
    'error.endpointNotFound': '存档列表服务未接线',
  ...
  en: {
    ...
    'list.total': 'Total',
    'list.retry': 'Retry',
    'mock.notice': 'Mock data source (not wired)',
    'type.full': 'Full',
    ...
    'error.endpointNotFound': 'Checkpoint list service is not wired',
