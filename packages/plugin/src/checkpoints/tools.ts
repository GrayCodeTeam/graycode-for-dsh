          ...
          properties: {
            preview: {
              ...
              properties: {
                ...
                error: { type: 'string' },
                legacy: { type: 'boolean', description: 'Legacy checkpoint: exact counts unknown (-1), based on the backup directory contents.' },
                failures: {
                  type: 'array',
                  items: {
                    type: 'object',
                ...
                missingBackupDirs: { type: 'array', items: { type: 'string' } },
                autoPrunedCheckpointCount: { type: 'integer' },
                excludedNote: {
                  type: 'object',
                  additionalProperties: false,
                  properties: {
                    ...
                    message: { type: 'string' },
                    snapshotRules: { type: 'object', additionalProperties: false, properties: { version: { type: 'integer' }, forcedRulesVersion: { type: 'integer' }, defaultProfileVersion: { type: 'integer' }, enabledProfiles: { type: 'object', additionalProperties: true }, profilePatterns: { type: 'object', additionalProperties: true }, maxFileSizeBytes: { type: 'integer' }, customPatterns: { type: 'array', items: { type: 'string' } } } },
                    currentRules: { type: 'object', additionalProperties: false, properties: { version: { type: 'integer' }, forcedRulesVersion: { type: 'integer' }, defaultProfileVersion: { type: 'integer' }, enabledProfiles: { type: 'object', additionalProperties: true }, profilePatterns: { type: 'object', additionalProperties: true }, maxFileSizeBytes: { type: 'integer' }, customPatterns: { type: 'array', items: { type: 'string' } } } },
                  },
                },
              },
            },
